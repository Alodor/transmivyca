...
$pdf->Cell(280,30, 'Listado de Choferes',0,0,'C');
...
$pdf->Cell(25,10,utf8_decode('Cédula'),1,0,'C',1);
...
$pdf->Cell(35,10,'Fecha Ingreso',1,0,'C',1);
...
foreach ($data as $key => $valor) {
    ...
    $pdf->Cell(25,10,$valor['cedula'],1,0,'C');
    $pdf->Cell(45,10,utf8_decode($valor['nombre']),1,0,'C');
    $pdf->Cell(45,10,utf8_decode($valor['apellido']),1,0,'C');
    $pdf->Cell(50,10,utf8_decode($valor['direccion']),1,0,'C');
    $pdf->Cell(30,10,$valor['telefono'],1,0,'C');
    $pdf->Cell(35,10,$valor['fecha_ingreso'],1,0,'C');
    $pdf->Cell(30,10,$valor['estatus'],1,1,'C');
}
